...
Usage (from repo root):
  uv run python -m openjiuwen.harness.tools.browser_move.backends.playwright_mcp.mcp_server
  uv run python -m openjiuwen.harness.tools.browser_move.backends.playwright_mcp.mcp_server --transport streamable-http --host 127.0.0.1 --port 8940
"""
...
for _p in (str(_REPO_ROOT), str(_SRC_ROOT), str(_HERE)):
