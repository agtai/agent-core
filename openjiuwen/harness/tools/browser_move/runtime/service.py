...
from ..chrome.managed_browser import ManagedBrowserDriver, _default_chrome_user_data_dir
...
class BrowserService:
    ...
    async def _check_connection(self) -> None:
        from ..backends.playwright_mcp.browser_tools import get_registered_client
