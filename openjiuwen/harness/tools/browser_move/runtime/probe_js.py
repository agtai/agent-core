# coding: utf-8
"""Pure in-page probe JavaScript for BrowserDriver.evaluate.

These sources are page-scoped function expressions (no Playwright page closures).
Runtime invokes them via driver.evaluate(source, args=params).
"""

from __future__ import annotations

BROWSER_STATE_SEMANTIC_JS = r"""() => {
